...
paraphraser = paraphrasingModule.araParaphraser()
...
@app.get("/")
def get_root():
    return "This is the RESTful API for Seyagha Smart Arabic Rephraser"
...
async def paraphrase_text(text: Paragraph):
    ...
    synonyms = kw_syn.getSynonymsForKeywords(paraphrased_text)

    return {
        "original": text.paragraph,
        "paraphrased": paraphrased_text,
        "keywords_synonyms": synonyms
    }